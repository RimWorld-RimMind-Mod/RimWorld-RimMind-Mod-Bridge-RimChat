...
namespace RimMind.Bridge.RimChat.Tests
{
    ...
    public class ContextPullBridgeTests
    {
        ...
        public void Register_RimChat不活跃_不注册任何Provider()
        {
            ...
            Assert.Equal(0, RimMind.Presentation.Api.RimMindAPI.ContextRegisterCount);
        }
        ...
        public void Register_RimChat活跃且enableContextPull开启_注册Provider()
        {
            ...
            Assert.Equal(2, RimMind.Presentation.Api.RimMindAPI.ContextRegisterCount);
        }
        ...
        public void Register_仅开启pullDiplomacyHistory_只注册1个Provider()
        {
            ...
            ContextPullBridge.Register();
            Assert.Equal(1, RimMind.Presentation.Api.RimMindAPI.ContextRegisterCount);
        }
        ...
        public void Unregister_注销所有Provider()
        {
            ...
            Assert.Equal(2, RimMind.Presentation.Api.RimMindAPI.ContextUnregisterCount);
        }
        ...
        public void Refresh_先注销再注册()
        {
            ...
            Assert.Equal(1, RimMind.Presentation.Api.RimMindAPI.ContextUnregisterCount);
            Assert.Equal(1, RimMind.Presentation.Api.RimMindAPI.ContextRegisterCount);
        }
